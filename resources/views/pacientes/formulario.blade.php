            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="dni" pattern="[0-9]{8}" placeholder="DNI sin puntos(.)" value="{{ isset($paciente)?$paciente->dni:old('dni') }}" required>
                    </div>
                </div>
                <div class="col-sm-5">
                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <input type="text" class="form-control" name="nombre" value="{{ isset($paciente)?$paciente->nombre:old('nombre') }}" required>
                    </div>
                </div>
                <div class="col-sm-5">
                    <div class="form-group">
                        <label for="apellido">Apellido</label>
                        <input type="text" class="form-control" name="apellido" value="{{ isset($paciente)?$paciente->apellido:old('apellido') }}" required>
                    </div>
                </div>
            </div>
        </fieldset>
        <div class="row">
            <div class="col-sm-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" value="{{ isset($paciente->fecha_nacimiento)?date('d/m/Y', strtotime($paciente->fecha_nacimiento)):old('fecha_nacimiento') }}">
                </div>
            </div>
            <div class="col-sm-2">
                <div class="form-group">
